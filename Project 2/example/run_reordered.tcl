...
set_scan_path chain0 -ordered_elements { \
  DFF_1/Q_reg                   \
  DFF_0/Q_reg                   \
  DFF_3/Q_reg                   \
  DFF_2/Q_reg                   \
...
write_test_protocol -output ${mydesign}_reordered.spf

check_design

change_names -rules verilog -hierarchy -verbose

write -format ddc -hierarchy -output  ${mydesign}_scan_netlist_reordered.ddc
write -format verilog -hierarchy -output  ${mydesign}_scan_netlist_reordered.v
write_sdf -version 2.1  ${mydesign}_scan_netlist_reordered.sdf
